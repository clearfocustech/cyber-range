...
ansible-playbook ./tasks/make_win_cd_bootable.yml -l test-win10,test-win2019 -i inventory.txt -b -k -K -u root --extra-vars "ansible_connection=local"
...
ansible-playbook ./tasks/install-windows-esxi.yml -l test-win10,test-win2019 -i inventory.txt -b -k -K -u root --extra-vars "ansible_connection=local"
ansible-playbook ./tasks/install-ubuntu-esxi.yml -l test-ubuntu22 -i inventory.txt -b -k -K -u root --extra-vars "ansible_connection=local"
...
ansible-playbook ./tasks/first-domain-controller.yml -l test-win2019 -i inventory.txt
